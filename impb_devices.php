...
function impb_format_device_row($device, $actions=false) {
	...
	form_selectable_cell("<a class='linkEditMain' href='impb_view_bindings.php?device_id=+" . $device["device_id"] . "&ip_filter_type_id=1&ip_filter=&mac_filter_type_id=1&mac_filter=&port_filter_type_id=&port_filter=&rows=-1&filter=&page=1&report=macs&x=22&y=4'>" . $device["ip_mac_total"] . "</a>", $device["device_id"]);
